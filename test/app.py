...
<div class="container">
    ...
    <form id="predictForm">
        <label>LIMIT_BAL: <input type="number" name="LIMIT_BAL" value="250000" required></label>
        ...
        <label>BILL_AMT1: <input type="number" name="BILL_AMT1" value="60000" required></label>
        <label>BILL_AMT2: <input type="number" name="BILL_AMT2" value="40000" required></label>
        <label>BILL_AMT3: <input type="number" name="BILL_AMT3" value="30000" required></label>
        <label>BILL_AMT4: <input type="number" name="BILL_AMT4" value="20000" required></label>
        <label>BILL_AMT5: <input type="number" name="BILL_AMT5" value="10000" required></label>
        <label>BILL_AMT6: <input type="number" name="BILL_AMT6" value="0" required></label>
        <label>PAY_AMT1: <input type="number" name="PAY_AMT1" value="10000" required></label>
        <label>PAY_AMT2: <input type="number" name="PAY_AMT2" value="10000" required></label>
        <label>PAY_AMT3: <input type="number" name="PAY_AMT3" value="10000" required></label>
        <label>PAY_AMT4: <input type="number" name="PAY_AMT4" value="10000" required></label>
        <label>PAY_AMT5: <input type="number" name="PAY_AMT5" value="10000" required></label>
        <label>PAY_AMT6: <input type="number" name="PAY_AMT6" value="10000" required></label>
        <label>Giới tính:
            <select name="SEX">
